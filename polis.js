...
function recommendTVNew(callback) { 
 ...
 function recommendTVNew1(apiresp) { 
     ...
     return ({ 
	         speech: "Hi are some recommendations for tonight", 
         displayText: "TV recommendations", 
         data:  jsonresp, 
         source: "Zero Service - app_zero.js" 
     }); 
...
function chatInitiate() {
    return ({
        speech: "Hi, I  Verizon Entertainment bot.Hello, I am Verizon Entertainment bot. I can help you with  TV Recommendations or Recording a program.What would you like to do?",
